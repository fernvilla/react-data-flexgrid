...
var DataRows = (function(_Component) {
  ...
  function DataRows() {
    ...
    return _possibleConstructorReturn(
      this,
      (DataRows.__proto__ || Object.getPrototypeOf(DataRows)).apply(this, arguments)
    );
  }
  ...
  _createClass(DataRows, [
    {
      ...
      value: function render() {
        ...
        var filteredData =
          allowSearch && searchText.length
            ? (0, _utils.searchData)(data, searchText, searchOptions, keys)
            : data;
